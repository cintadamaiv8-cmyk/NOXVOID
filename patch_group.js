...
// Append showEditName dialog
if(!code.includes('showEditName) {')) {
    code = code.replace(
...
fs.writeFileSync('app/src/main/java/com/example/ui/screens/GroupProfileScreen.kt', code.replace(/\\/g, ''));
console.log("Patched GroupProfileScreen successfully");
